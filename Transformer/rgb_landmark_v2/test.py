...
def plot_confusion_matrix(y_true, y_pred, labels, output_file="/work/huong.nguyenthi2/Vietnam_Signlanguage_FE/Transformer/rgb_landmark_v2/confusion_matrix.png"):
...
def main(dataset_root_path="/work/21013187/SAM-SLR-v2/data/person_with_backgrounds",
         model_ckpt_path="/work/huong.nguyenthi2/Vietnam_Signlanguage_FE/Transformer/rgb_landmark_v2/videomae-base-finetuned_47classes/checkpoint-3300",
