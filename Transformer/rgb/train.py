...
def main(dataset_root_path= "/work/21013187/SAM-SLR-v2/data/rgb",
    ...
    model = VideoMAEForVideoClassification.from_pretrained("/work/21013187/linh/Vietnam_Signlanguage_FE/Transformer/rgb/videomae-base-finetuned/checkpoint-8370",
        # model_ckpt,
        # label2id=label2id,
        # id2label=id2label,
